      ...
      in
      {
        devShells.default = pkgs.mkShell {
          ...
          shellHook = ''
            ...
            mkdir -p "$ANDROID_HOME/platform-tools" "$ANDROID_HOME/emulator"
            ...
            # Copy SDK components (exclude system-images)
...
EOF
            ...
            # Install google_apis system image if missing
            ...
            # Create default emulator if it does not exist
