  ...
  outputs = { self, nixpkgs, flake-utils, android-nixpkgs }:
	...
	flutterBuildConfigs = pkgs.stdenv.mkDerivation {
	  ...
	  buildPhase = ''
	    ...
	    cat > $out/android/build.gradle <<EOF
	    ...
	    cat > $out/android/build.gradle.kts <<EOF
	      // Top-level build file where you can add configuration options common to all sub-projects/modules.
	      buildscript {
	    ...
	    cat > $out/android/gradle/wrapper/gradle-wrapper.properties <<EOF
	...
	# Generate android/app/build.gradle with pinned Kotlin version.
	    cat > $out/android/app/build.gradle <<EOF
